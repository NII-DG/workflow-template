...
def generate_svg_diag(
        output='WORKFLOWS/data/flow/research_notebooks.svg',
        diag='WORKFLOWS/data/flow/research_notebooks.diag',
        dir_util='WORKFLOWS/notebooks/research',
        font='.fonts/ipag.ttf',
):
...
def _embed_info_in_one_rect(elem, nb_headers, nb_name):
    ...
    nb_file = nb_file.replace(dg_path.RES_DIR_PATH, '.')
