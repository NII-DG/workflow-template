...
def res_top_html():
    ...
    return button_html(top_path, message.get("menu", "reserch_top"))
...
def res_top_link_from_maDMP():
    ...
    html_text = button_html(top_path, message.get("menu", "reserch_top"))
    display(HTML(html_text))
...
def exp_top_html():
    ...
    return button_html(top_path, message.get("menu", "experiment_top"))
