...
def test_raise_dg_task_error_from_unexpected():
    # pytest -v -s tests/nb_libs/utils/common/test_raise_error.py::test_raise_dg_task_error_from_unexpected
...
def test_not_exec_pre_cell_raise():
    # pytest -v -s tests/nb_libs/utils/common/test_raise_error.py::test_not_exec_pre_cell_raise
